...
export function WhatsAppFloat() {
  return (
    <motion.a
      ...
      className="group animate-wa-breathe fixed bottom-6 right-6 z-50 flex items-center rounded-full border border-primary/55 bg-dark transition-all duration-500 hover:border-primary"
    >
      <span className="flex h-14 w-14 shrink-0 items-center justify-center">
        {/* WhatsApp glyph in brand tones */}
        <svg viewBox="0 0 24 24" className="h-6 w-6 fill-primary transition-transform duration-500 group-hover:scale-110" aria-hidden="true">
      ...
      <span className="max-w-0 overflow-hidden whitespace-nowrap text-[11px] font-bold uppercase tracking-[0.18em] text-surface opacity-0 transition-all duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:max-w-44 group-hover:pr-6 group-hover:opacity-100">
        Chat with Viren
      </span>
    </motion.a>
  );
