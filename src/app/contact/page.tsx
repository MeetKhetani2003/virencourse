    ...
    <>
            ...
            <div className="relative overflow-hidden rounded-[2.5rem] border border-blue-100 bg-white shadow-2xl shadow-blue-900/5 p-8 md:p-14">
              ...
              <div className="relative z-10 text-center mb-12">
                ...
                <h2 className="font-serif text-3xl md:text-4xl font-medium text-slate-900 mb-4">
                  1-on-1 Personal Counselling <span className="text-blue-600">with Viren</span>
                </h2>
                <p className="max-w-2xl mx-auto text-[16px] leading-relaxed text-slate-600">
                  Feeling stuck in studies, career, money, or life? In this private 90-minute counselling session, I'll help you identify your challenges and create a practical action plan using powerful NLP techniques.
                </p>
              </div>
              ...
              <div className="relative z-10 grid md:grid-cols-2 gap-10 lg:gap-16 mb-12">
                ...
                <div>
                  ...
                  <ul className="space-y-4 text-[14.5px] text-slate-700 font-medium">
                    ...
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="h-5 w-5 text-blue-600 shrink-0 mt-0.5" />
                      <span>NLP-Based Counselling</span>
                    </li>
                  </ul>
                </div>
              </div>
      ...
      <section className="bg-light py-12 lg:py-28">
        <div className="mx-auto grid max-w-[1280px] gap-7 px-6 md:grid-cols-3 lg:px-10">
          ...
          <Reveal delay={0.2}>
            <div className="group flex h-full flex-col border border-dark/10 bg-white/60 p-9 transition-all duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] hover:-translate-y-1.5 hover:shadow-[0_32px_60px_-34px_rgba(11,11,12,0.35)]">
              <span className="flex h-12 w-12 items-center justify-center rounded-full border border-dark/20 group-hover:border-primary/50 group-hover:bg-primary/5 transition-colors">
                <Mail className="h-5 w-5 text-muted group-hover:text-primary transition-colors" strokeWidth={1.4} />
              </span>
              <h2 className="mt-7 font-serif text-2xl font-medium text-dark">Email</h2>
              <p className="mt-2.5 text-[14px] leading-relaxed text-muted">
                Send an email for business inquiries, detailed course questions, or collaborations.
              </p>
              <a href="mailto:Virensurati1234@gmail.com" className="mt-8 inline-flex items-center gap-2 font-serif text-lg text-dark transition-colors duration-300 hover:text-primary break-all">
                Virensurati1234@gmail.com
              </a>
              <a href="mailto:Virensurati1234@gmail.com" className="link-draw mt-6 text-dark">
                Click to Email
              </a>
            </div>
          </Reveal>
